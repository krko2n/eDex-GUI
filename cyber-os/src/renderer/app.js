...
class CyberOS {
    ...
    init() {
        ...
        console.log('xKOR_3RR0R v2.1 INITIALIZED');
    }
    ...
    startBootSequence() {
        ...
        const bootMessages = [
            'root@xKOR_3RR0R:~$ ./boot.sh',
            '[ OK ] Initializing Kernel OSI...',
            '[ OK ] Mounting Neural Interface...',
            '[ OK ] Loading xGLY-TCH Renderer...',
            '[!!] LOADING xKOR_3RR0R_v2.1... [F4I1UR3]',
            '[!!] CONTINUING... [RISK_ACTIVE]',
            '===========================================',
            '         X K O R _ 3 R R 0 R',
            '==========================================='
        ];
        ...
        const printMessage = () => {
            if (messageIndex < bootMessages.length) {
                ...
                messageIndex++;
                progress = Math.min(progress + (100 / bootMessages.length), 100);
                progressFill.style.width = progress + '%';
                progressText.textContent = Math.round(progress) + '%';
                setTimeout(printMessage, 500);
            } else {
                // Messages done, now wait for WebSocket
                initWebSocket(() => {
                    // Connected, hide boot screen
